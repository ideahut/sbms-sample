...
<ideahut:block target="style">	
	<link href="<ideahut:static item="plugins/morrisjs/morris.css"/>" rel="stylesheet"  data-cfasync="false"/>
</ideahut:block>

<ideahut:block target="script">
	<%-- Morris Plugin Js --%>
    <script src="<ideahut:static item="plugins/raphael/raphael.min.js"/>" data-cfasync="false"></script>
    <script src="<ideahut:static item="plugins/morrisjs/morris.js"/>" data-cfasync="false"></script>
    <%-- ChartJs --%>
    <script src="<ideahut:static item="plugins/chartjs/Chart.bundle.js"/>" data-cfasync="false"></script>
    <%-- Flot Charts Plugin Js --%>
    <script src="<ideahut:static item="plugins/flot-charts/jquery.flot.js"/>" data-cfasync="false"></script>
    <script src="<ideahut:static item="plugins/flot-charts/jquery.flot.resize.js"/>" data-cfasync="false"></script>
    <script src="<ideahut:static item="plugins/flot-charts/jquery.flot.pie.js"/>" data-cfasync="false"></script>
    <script src="<ideahut:static item="plugins/flot-charts/jquery.flot.categories.js"/>" data-cfasync="false"></script>
    <script src="<ideahut:static item="plugins/flot-charts/jquery.flot.time.js"/>" data-cfasync="false"></script>
    <%-- Sparkline Chart Plugin Js --%>
    <script src="<ideahut:static item="plugins/jquery-sparkline/jquery.sparkline.js"/>" data-cfasync="false"></script>
    <%-- Custom Js --%>
    <script src="<ideahut:static item="js/admin.js"/>" data-cfasync="false"></script>
    <script src="<ideahut:static item="js/pages/index.js"/>" data-cfasync="false"></script>
    <%-- Demo Js --%>
    <script src="<ideahut:static item="js/demo.js"/>" data-cfasync="false"></script>
</ideahut:block>

<ideahut:block target="content">
			...
			<div class="card">
				<div class="body bg-pink">
					...
					<ul class="dashboard-stat-list">
						...
						<li>LAST WEEK <span class="pull-right"><b>26 582</b> <small>USERS</small></span>
						</li>
					</ul>
				</div>
			</div>
...
<%@ include file="/WEB-INF/tiles/base.jsp" %>